...
export class ItemsController {
  ...
  findAll(
    ...
    return this.itemsService.findAll({ page: +page || 1, pageSize: +pageSize || 20, search, category, status });
  }
  ...
  async update(@Param('id') id: string, @Body() dto: UpdateItemDto, @CurrentUser() user: any) {
